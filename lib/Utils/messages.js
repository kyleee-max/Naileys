 ...
 * @typedef {{ upload: (stream: Buffer | import('stream').Readable, opts?: AnyObject) => Promise<AnyObject>; mediaCache?: Map<string, Buffer>; newsletter?: boolean; mediaTypeOverride?: string; mediaUploadTimeoutMs?: number; options?: AnyObject; logger?: { debug?: (...args: any[]) => void; warn?: (...args: any[]) => void; info?: (...args: any[]) => void; child?: (meta: any) => any }; backgroundColor?: string; font?: string; getProfilePicUrl?: (jid: string, type: string) => Promise<string | undefined>; getUrlInfo?: (url: string) => Promise<AnyObject | undefined>; }} PrepareMessageOptions
 */
const MIMETYPE_MAP = {
    image: 'image/jpeg',
    video: 'video/mp4',
