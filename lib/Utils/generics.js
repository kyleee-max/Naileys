...
const naileys_version_json_1 = require("../Defaults/naileys-version.json");
...
/**
 * JSON serializer/deserializer for Buffer values.
 */
exports.BufferJSON = {
    replacer: (k, value) => {
...
const fetchLatestWileysVersion = async (options = {}) => {
    try {
        ...
        return {
            version: naileys_version_json_1.version,  
            isLatest: false,
            error
        };
    }
