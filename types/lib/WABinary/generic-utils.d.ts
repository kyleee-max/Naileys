...
export function getBinaryNodeChildBuffer(node: any, childTag: any): Uint8Array<ArrayBufferLike> | Buffer<ArrayBufferLike>;
export function getBinaryNodeChildString(node: any, childTag: any): string;
